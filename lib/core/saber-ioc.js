 ...
 * @param id
 */
exports.MetaKey = function (id) { return META + ":" + id; };
/**
 * # DepKey
 * return a DEP key.
 * @param id
 */
exports.DepKey = function (id) { return DEP + ":" + id; };
/**
 * # Injectable
...
function Injectable(id) {
    return function (target) {
        if (Reflect.hasMetadata(exports.MetaKey(id), MetaStore)) {
            throw new Error("id:[" + id + "] is existed!");
        }
        else {
            Reflect.defineMetadata(exports.MetaKey(id || target.name), target, MetaStore);
        }
    };
}
...
function Inject(id) {
    return function (target) {
        return Reflect.defineMetadata(exports.DepKey(id), Reflect.getMetadata(exports.MetaKey(id), MetaStore), target);
    };
}
