...
var CUSTOM;
(function (CUSTOM) {
    CUSTOM["META"] = "saber_meta";
    CUSTOM["MAIN"] = "saber_main";
})(CUSTOM || (CUSTOM = {}));
/**
 * # CLASSTYPE
 */
var CLASSTYPE;
(function (CLASSTYPE) {
    CLASSTYPE["STATIC"] = "saber_singleton";
})(CLASSTYPE || (CLASSTYPE = {}));
/**
 * # MetaKey
 * return a META key.
 * @param id
 */
var MetaKey = function (id) { return CUSTOM.META + ":" + id; };
/**
 * # Injectable
...
(function (SaFactory) {
    ...
    function create(constructor) {
        ...
        var depKeys = Reflect.getMetadataKeys(constructor)
            .filter(function (key) { return key.indexOf(CUSTOM.META) !== -1; })
            .reverse();
        var dependenciesMeta = depKeys.map(function (key) {
            if (Reflect.hasMetadata(key, MetaStore)) {
                ...
                throw new Error("cannot found " + key.replace(CUSTOM.META, 'dependence') + " in container.");
            }
        });
        if (Reflect.hasMetadata(DESIGN.PARAMTYPES, constructor)) {
            ;
            Reflect.getMetadata(DESIGN.PARAMTYPES, constructor).forEach(function (value, index) {
        ...
        function Container() {
            ...
            this.main =
                Constructors.find(function (constructor) {
                    return Reflect.hasMetadata(CUSTOM.MAIN, constructor);
                }) || Constructors[0];
        }
        /**
         * pull
